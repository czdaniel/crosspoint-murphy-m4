...
inline std::vector<SettingInfo> getSettingsList(const SdCardFontRegistry* registry = nullptr,
  ...
  static const std::vector<SettingInfo> baseList = [] {
    ...
    std::vector<SettingInfo> v = {
        ...
        SettingInfo::Enum(StrId::STR_SLEEP_SCREEN_CLEANUP, &CrossPointSettings::sleepScreenCleanup,
                          {StrId::STR_CLEANUP_FAST, StrId::STR_CLEANUP_CLEAN, StrId::STR_CLEANUP_MAXIMUM},
                          "sleepScreenCleanup", StrId::STR_CAT_DISPLAY),
