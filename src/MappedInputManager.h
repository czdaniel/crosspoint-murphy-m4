...
class MappedInputManager {
 public:
  ...
  // Rect-filtered variant that suppresses the contact only when the long
  // press lands inside the requested target.
  bool wasScreenLongPressInRect(int x, int y, int width, int height) const;
